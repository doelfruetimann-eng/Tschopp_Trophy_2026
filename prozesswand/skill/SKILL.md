---
name: prozesswand
description: Überträgt eine Idee oder Diskussion aus dem Chat in die OSTO/SYMA-Prozesswand von Dölf Rütimann. Erstellt eine SMART-Zieldefinition und fertige Eingaben für den KI-Struktur-Dialog der Wand. Verwenden, wenn der Nutzer /prozesswand schreibt oder eine Idee "auf die Prozesswand" übertragen will.
---
...
3. **Ausgabe** — immer genau dieses Format, kopierfertig:
...
- Das Ziel gehört dem Nutzer: Wenn er Anpassungen nennt, direkt einarbeiten und
  den Block aktualisiert erneut ausgeben.
